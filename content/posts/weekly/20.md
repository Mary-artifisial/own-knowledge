...
![把一个操作分成大致的几个步骤](https://r2.eltr.ac/uPic/2025/03/progress-prep-r6.jpg "把一个操作分成大致的几个步骤")

![如果不确定总步骤，就计算当前已经完成的步骤](https://r2.eltr.ac/uPic/2025/03/progress-count-r2.jpg "如果不确定总步骤，就计算当前已经完成的步骤")
...
![image-20250316100620618](https://r2.eltr.ac/uPic/2025/03/image-20250316100620618.png)
